...
export const TextHoverEffect = ({
  ...
  return (
    ...
    >
        ...
        >
          {hovered && (
            <>
              ...
              <stop offset="50%" stopColor="rgba(160, 200, 255, 0.7)" />
      ...
      {/* Background stroke - visible on hover */}
      <text
        x="50%"
        y="50%"
        textAnchor="middle"
        ...
        style={{ opacity: hovered ? 0.7 : 0, letterSpacing: "0.35em" }}
      >
        {text}
      </text>
